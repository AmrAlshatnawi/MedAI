...
st.markdown("""
    <div style="
        ...
        <p>Dive right into our <strong>AI-powered Medical Assistance Chat</strong> for instant insights and support on health queries. Or, explore our <strong>Dynamic Data Tool</strong> for a visual snapshot of vital health trends and data insights.</p>
        <p>
